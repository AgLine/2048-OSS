...
public static int do_a_Left(JLabel[][] matrixGame){
...
public static int do_d_Right(JLabel[][] matrixGame){	
...
public static int do_w_Up(JLabel[][] matrixGame){	
	...
	public static int do_s_Down(JLabel[][] matrixGame){	
